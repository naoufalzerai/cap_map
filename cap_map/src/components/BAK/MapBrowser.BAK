...
export class MapBrowser extends Component {
  ...
  ref={pan => (this.pan = pan)} >
                ...
                <svg style={divBrowser}  ref={node => (this.node = node)} width={900} height={350}>
                    <defs>
    ...
    <div className="col-2" style={{    overflowY: "scroll",height: "410px"}}>
    <div className="row">

<div className="profile-sidebar">
				<div className="profile-userpic">
					< img src = "https://png2.kisspng.com/20180408/yse/kisspng-user-computer-icons-gravatar-blog-happy-woman-5aca6d042ec0c5.9646103315232156201915.png"
